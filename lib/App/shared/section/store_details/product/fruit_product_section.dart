...
class FruitProductsection extends GetView<ProductController> {
  final String storeName;
  final CartController cartController; // Terima controller dari atas

  const FruitProductsection({
    super.key,
  ...
  Widget build(BuildContext context) {
    // Tidak perlu Get.find() lagi di sini
    return Obx(() {
      final products = controller.allFruitProducts;
        ...
        child: ListView.separated(
          ...
          itemBuilder: (_, index) {
            ...
            return ProductBox(
              ...
              storeName: storeName,
              onButtonPressed: () =>
                  // Langsung gunakan cartController yang sudah diterima
