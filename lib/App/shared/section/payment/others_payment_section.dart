...
class OthersPaymentSection extends GetView<PaymentController> {
  const OthersPaymentSection({super.key});
        ...
        Container(
          ...
          child: Obx(
            () => ListView.separated(
              ...
              itemCount: controller.othersPaymentMethod.length,
              ...
              itemBuilder: (context, index) {
                // Perbaikan variabel
                final method = controller.othersPaymentMethod[index];
                return PaymentTile(
                  method: method,
                  isSelected:
